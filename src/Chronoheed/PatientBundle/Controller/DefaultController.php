...
class DefaultController extends Controller
{
    ...
    public function updatePatientFileAction($patient_id, Request $request)
    {
        try {
            ...
            if(isset($patient_data['isPregnant'])){
                $patient_data['isPregnant'] = filter_var($patient_data['isPregnant'], FILTER_VALIDATE_BOOLEAN);
            }
            if(isset($patient_data['isPregnant'])){
                $patient_data['isBreastFeeding'] = filter_var($patient_data['isBreastFeeding'], FILTER_VALIDATE_BOOLEAN);
            }
